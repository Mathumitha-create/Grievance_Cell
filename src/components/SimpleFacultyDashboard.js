...
const SimpleFacultyDashboard = ({ user }) => {
    ...
    const unsubscribe = onSnapshot(q, 
      (snapshot) => {
        ...
        const academicComplaints = allComplaints.filter((c) => {
          ...
          return category.includes('academic') || 
        ...
        console.log("✅ Academic complaints loaded:", academicComplaints.length);
  ...
  const speakText = (text, complaintId) => {
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial', minHeight: '100vh', background: '#f3f4f6' }}>
      ...
      <div style={{ 
        ...
        {["All", "Pending", "In Progress", "Resolved"].map((status) => (
          <button
            ...
            style={{
              padding: '8px 16px',
              border: filter === status ? `2px solid ${isHOD ? '#8b5cf6' : '#10b981'}` : '2px solid #e5e7eb',
              background: filter === status ? (isHOD ? '#ede9fe' : '#d1fae5') : 'white',
              color: filter === status ? (isHOD ? '#6b21a8' : '#065f46') : '#6b7280',
              borderRadius: '6px',
              cursor: 'pointer',
      ...
      <div style={{
        ...
        <h2 style={{ marginTop: 0, color: '#1f2937', marginBottom: '20px' }}>
          📚 <TranslatedText text="Academic Complaints" /> ({filteredComplaints.length})
        </h2>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '5px', flexWrap: 'wrap' }}>
                      ...
                      <button
                        ...
                        style={{
                          background: speakingId === complaint.id ? '#ef4444' : isHOD ? '#8b5cf6' : '#10b981',
                          color: 'white',
                          border: 'none',
                          borderRadius: '50%',
                          width: '32px',
